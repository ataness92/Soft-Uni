...
class TestCat(TestCase):
    ...
    def test_correct_init(self):
        self.assertEqual("Many", self.cat.name)
        self.assertFalse(self.cat.fed)
        self.assertFalse(self.cat.sleepy)
        self.assertEqual(0, self.cat.size)

    def test_feed_cat_makes_cat_sleepy_and_not_hungry_expect_size_increase(self):
    ...
    def test_if_cat_is_fed_expect_error(self):
        self.cat.fed = True
