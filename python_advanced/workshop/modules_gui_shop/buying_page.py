from python_advanced.workshop.modules_gui_shop.helpers import clean_screen
...
def display_stock():
    ...
    for item_name, item_info in info.items():
        ...
        images.append(item_img) # keeping the reference to the image
        ...
        frame.create_text(x, y + 180, text=text, fill=color, font=("Comic Sans MS", 15))
