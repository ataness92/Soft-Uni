...
from python_advanced.workshop.modules_gui_shop.buying_page import display_products
...
def register():
    ...
    frame.create_window(300, 200, window=register_button)
...
def login():
    ...
    frame.create_window(250, 200, window=login_button)
